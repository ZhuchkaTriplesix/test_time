"""Адаптер доставки уведомлений воркера.

Назначение:
- Отправка уведомлений в сторонние сервисы (Telegram, Email, Webhooks, логирование).
- Симуляция задержки сети для тестирования асинхронной неблокирующей работы.
"""
