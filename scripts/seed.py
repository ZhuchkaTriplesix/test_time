#!/usr/bin/env python3
"""Скрипт генерации демонстрационных данных (Seed Script).

Назначение:
- Автоматическая отправка тестовых клиентских обращений по разным направлениям через API.
- Симуляция быстрых ответов сотрудников для заполнения метрик и демонстрации работы дашборда.
"""
