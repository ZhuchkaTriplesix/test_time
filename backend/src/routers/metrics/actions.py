"""Бизнес-логика сбора агрегированных метрик эффективности.

Назначение:
- Координация получения аналитических показателей через DAL-слой с фильтрацией по временным окнам.
"""
