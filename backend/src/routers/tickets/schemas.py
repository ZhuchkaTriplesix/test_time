"""Pydantic-схемы для представления обращений в API.

Назначение:
- Описание структуры отдельного тикета (`TicketResponse`) с полями ожидания и статуса SLA.
- Описание структуры списка тикетов (`TicketListResponse`) с метаинформацией и списком тем.
"""
